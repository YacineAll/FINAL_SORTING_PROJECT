...
int main(int argc, char ** argv){
  ...
  //Varibables qui vont service au calcule du temps d'ex�cution 
  double  temps;
  clock_t t1, t2;
  ...
  //Affichage d'un Message enregitr� dans un fichier 
  FILE *f=NULL;
 ...
 menu:
  ...
  printf("\n============================MENU=================================\n");	
  printf("Choisir La structure de Donn�es pour Trouv� la solution du Robot trieur !\n");
  printf("\t 1- Struture de Matrice !                                              \n");
  printf("\t 2- structure de Liste doubelement chainn�es                           \n");
  printf("\t 3- Strucutre de Graphe !                                              \n");
  printf("\t 4- Quitter                                                            \n"); 
  printf("\n\nquelle est votre choix?  ");

  
  //R�cup�r� le chois de l"utilisateur  a l'aide d'un entier designant son choix 
  scanf("%d",&choix);
  system("clear");
  ...
  if(choix != 1 &&  choix!=2 &&  choix!=3 &&  choix!=4)
    {
      ...
      printf(" choissir r�ponse Valide {1,2,3,4} C'est un Jeu D'enfant !  ");
      goto menu;
  ...
  switch (choix)
    ...
    case 1:
                 ...
                 printf("\n\n Vous avez chosir la structure de matrice faire attention � ne pas sortir des bordure !!!!\n");
      
                 //choisir entre Algorithme naif et circulaire 
                 int choix2=10;

                 menu1:
		 //Menu qui permet � l'utilisateur de choisir le type d'algorithme a utilis�! ");
		 printf("\n\nVous avez Choisie La Structure Matricielle  :\n\t\t choissez L'algorithme � utilis� !?\n");
		 printf("\t\t\t 1- Algorithme naif\n");
		 printf("\t\t\t 2- Algorithme Circulaire\n");
		 printf("\t\t\t 0- Revenir en Arriere                                                                                   ");	
		 
		 
		 //recup�ration du choix de l'utilisateur 
		 printf("\n\n Quelle est votre choix ? ");
		 scanf("%d",&choix2);
		   ...
		   case 1:
		     {
		       ...
		       printf("\n\nVous avez choisie l'algorithme naif !!!!! \n\t bonne id�e mais comme a dit Anne Barratin :\n <<La ruse aime � se cacher sous la na�vet�, comme une reprise sous un ruban>> \n");

		       //Capturer le temps d'entre � la fonction de L'algorithme NAIF
		       t1 = clock();
		   ...
		   case 2:
		     {
		       ...
		       printf("\n\nVous avez choisie L'agorithme Circulaire \n\t Attention � ne pas tourn� en rond !!\n");


		       //capturer le temps d'entr� vers L'algorthme Circulaire 
		       t1 = clock();
    ...
    case 2:
      {
	                    ...
	                    //Execution de l'algorithme utilsant Les Listes Doublement chain�es !!
	                    printf(" Vous  Avez Choisie L'algorithme Utilisatant LEs Liste Doublement Chain�es \n\t\t bon choix cot� rapidit� mais Vous Vous  etes Posez La Question de La Memoire !!!!? \n\n "); 

			    
			    //caputer le temps de debut
			    t1 = clock();
			    
			    //Appel � l'ALGORITHME Utilisant les Listes Doublement Chain�es 
			    algorithme_LDC(G,S);
...
// Le Choix de L'algorithe entre Graphe et AVL 
    case 3:
      {
		  ...
		  printf("\t 0- Retour en arri�re                                        \n");
		  
		  
		  //recup�ration du chois de l'utilisateur
		  printf("\n\nQuelle est votre Choix? ");
		  scanf("%d",&choix3);
		  system("clear");
		  ...
		  switch (choix3)
			...
			int rep=-1;
			printf(" Voulez vous R�essayer encore avec Un autre ?? \n je sais c'est  marrant !!!\n");
			do
			  {
			    printf(" \t\tVotre reponse ? 1 -OUI 0- NON (Cot� Binaire!! ) ");
			    scanf("%d",&rep);
			  }
			while (rep !=0 && rep !=1);
			if(rep)
 ...
 fin:
  ...
  //affichage du temps exploit� par l'algoithme pour trouv� la solution 
